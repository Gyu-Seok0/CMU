...
class GRUTest(Test):
    ...
    def gru_cell_backward(self, idx):
        ...
        print('dx_t, type:', self.assertions(my_dx, py_dx, 'type', 'dx_t'))
        print('dx_t, shape:', self.assertions(my_dx, py_dx, 'shape', 'dx_t'))
        print('dx_t, closeness:', self.assertions(my_dx, py_dx, 'closeness', 'dx_t'))
        print()
        print('dh_t, type:', self.assertions(my_dh, py_dh, 'type', 'dh_t'))
        print('dh_t, shape:', self.assertions(my_dh, py_dh, 'shape', 'dh_t'))
        print('dh_t, closeness:', self.assertions(my_dh, py_dh, 'closeness', 'dh_t'))
