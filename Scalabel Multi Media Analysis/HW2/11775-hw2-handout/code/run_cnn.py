...
class ExtractCNNFeature(System):
    ...
    def get_stages(self, resources):
        ...
        stages = [
            ...
            CNNFeature(cnn_resources, model_name='convnext_base',
...
def parse_args(argv=None):
    ...
    parser.add_argument(
        '--video_dir', default=osp.join(
            osp.dirname(__file__), '/data/gyuseok/videos'))
    parser.add_argument(
        '--cnn_dir', default=osp.join(osp.dirname(__file__), '../data/cnn_conv3'))
    ...
    parser.add_argument('--job_timeout', type=int, default = 20) #10
